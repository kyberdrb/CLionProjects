...
const static int constStaticVariableInitInClass = 911;  // no linkage conflict

int main() {
//    Foo::constStaticVariableInitInClass = 3;    // error: assignment of read-only variable
//    Foo::constexprNonintegralStaticVariableInitInClass = 4; // error: assignment of read-only variable; 'constexpr' implies 'const'
