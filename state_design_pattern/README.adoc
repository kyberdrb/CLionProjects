...
// TODO further development - tasks postponed in order to keep accuracy with the original state machine diagram on refactoring.guru site
        ...
        // TODO v3: Precreate all states and save them to 'hashmap<StateEnum, State>' and then change references at transitions instead of creating new instance at each transition
        //  Create a member variable of unique_ptr<States> type in 'State' class
        ...
        //  with
        //      State::_document.changeStateTo(this->states->getState(StateTypes::PUBLISHED));
        //  or even simpler
        //      State::_document.changeStateTo(this->states->getPublishedState());
